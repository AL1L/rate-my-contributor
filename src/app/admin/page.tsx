      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div>
          ...
          <div className="space-y-4">
            {allRatings.slice(0, 20).map((rating) => (
              <Card key={rating.id} className="p-4">
                <div className="flex justify-between items-start">
                  <div>
                    <div className="flex items-center gap-2 mb-2">
                      <span className="text-2xl font-bold text-yellow-500">{rating.score}</span>
                      <span className="text-sm text-zinc-600 dark:text-zinc-400">/ 5</span>
                    </div>
                    {rating.comment && (
                      <p className="text-sm text-zinc-700 dark:text-zinc-300">{rating.comment}</p>
                    )}
